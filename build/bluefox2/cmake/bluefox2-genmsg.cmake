...
get_filename_component(_filename "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv" NAME_WE)
add_custom_target(_bluefox2_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bluefox2" "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv" ""
)
...
_generate_srv_cpp(bluefox2
  "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(bluefox2
  "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bluefox2
)

### Generating Module File
_generate_module_eus(bluefox2
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bluefox2
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(bluefox2_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(bluefox2_generate_messages bluefox2_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv" NAME_WE)
add_dependencies(bluefox2_generate_messages_eus _bluefox2_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(bluefox2_geneus)
add_dependencies(bluefox2_geneus bluefox2_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bluefox2_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(bluefox2
  "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bluefox2
)

### Generating Module File
_generate_module_nodejs(bluefox2
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bluefox2
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(bluefox2_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(bluefox2_generate_messages bluefox2_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/asctec/catkin_ws/src/bluefox2/srv/SetExposeSrv.srv" NAME_WE)
add_dependencies(bluefox2_generate_messages_nodejs _bluefox2_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(bluefox2_gennodejs)
add_dependencies(bluefox2_gennodejs bluefox2_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bluefox2_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bluefox2)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bluefox2
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(bluefox2_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bluefox2)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bluefox2
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(bluefox2_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
